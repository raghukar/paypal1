...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.1.6/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | AT & T_ATTI-CKT-PF-2-172.16.99.17 | routed | - | 172.16.99.17/28 | default | - | False | - | - |
...
!
interface Ethernet1
   description AT & T_ATTI-CKT-PF-2-172.16.99.17
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 172.16.99.17/28
!
interface Ethernet2
   switchport
   flow tracker hardware FLOW-TRACKER
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| default | 0.0.0.0/0 | 172.16.99.18 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 0.0.0.0/0 172.16.99.18
```
