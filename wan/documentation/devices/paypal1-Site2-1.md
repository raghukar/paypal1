...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.1.10/24 | - |
...
| ------------ | --------------------------------- | ------------------------- | ------------------- | ---------- |
| FLOW-TRACKER | 70000 | 5000 | 1 | Dps1<br>Ethernet1<br>Ethernet4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | AT & T_ATTI-CKT-110-1-172.16.110.1 | routed | - | 172.16.110.1/24 | default | 1600 | False | - | - |
| Ethernet4 | - | routed | - | 10.1.110.3/24 | prod | - | False | - | - |
...
!
interface Ethernet1
   description AT & T_ATTI-CKT-110-1-172.16.110.1
   no shutdown
   mtu 1600
   no switchport
   flow tracker hardware FLOW-TRACKER
...
| Loopback1 | - | prod | 10.254.110.1/32 |
...
!
interface Vxlan1
   description paypal1-Site2-1_VTEP
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| default | 0.0.0.0/0 | 172.16.110.2 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 0.0.0.0/0 172.16.110.2
```
...
| Hierarchy | Name | ID |
| --------- | ---- | -- |
| Region | paypal1_region1 | 1 |
| Zone | paypal1_region1-ZONE | 1 |
| Site | Site2 | 100 |
...
| prod | 192.168.110.1:1 | connected |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.254.110.1:100 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.254.110.1:100 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.254.110.1:100 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.254.110.1:100 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.254.110.1:100
```
...
| -------------- | -------------- | ---------------------- |
| Ethernet1 | - | internet-paypal1-pf1-Ethernet1<br>internet-paypal1-pf2-Ethernet1 |
...
| --------- | ---- | ---------------- |
| 192.168.99.1 | paypal1-pf1 | 172.16.99.1 |
...
| LB-PROD-AVT-POLICY-Critical-APP | - | - | - | internet (1) | True |
| LB-PROD-AVT-POLICY-DEFAULT | - | - | - | internet (1) | False |
| LB-PROD-AVT-POLICY-IT-APP | - | - | - | internet (1) | False |
| LB-PROD-AVT-POLICY-Voice | - | - | - | internet (1) | False |
...
router path-selection
   ...
   load-balance policy LB-PROD-AVT-POLICY-Critical-APP
      hop count lowest
      path-group internet priority 1
   !
...
| -------------- | ---------- | ----------- | ---- |
| internet-paypal1-pf1-Ethernet1 | 172.16.99.1 | - | 3478 |
| internet-paypal1-pf2-Ethernet1 | 172.16.99.17 | - | 3478 |
